...
from rov_thruster_manager.thruster import Thruster
from rov_thruster_manager.thrusterAllocationMatrix import ThrusterAllocationMatrix
from rov_thruster_manager.coefficient import Coefficient
        ...
        for i in range(len(transforms)):
            ...
            if self.param_thruster_prefix in transform.child_frame_id:
                ...
                thruster = Thruster(msg=transform,
                                    ...
                                    publish_wrench_type="SEP_WRENCH"
                                    )
